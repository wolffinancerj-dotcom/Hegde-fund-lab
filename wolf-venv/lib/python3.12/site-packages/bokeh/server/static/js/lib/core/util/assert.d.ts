...
export declare function assert_debug(condition: boolean, message?: string): asserts condition;
export declare function assert_debug(condition: boolean | (() => boolean), message?: string): void;
